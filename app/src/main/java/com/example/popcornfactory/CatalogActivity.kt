...
class CatalogActivity : AppCompatActivity() {
    ...
    var peliculas=ArrayList<ObjetosNegocio>()
    ...
    class PeliculaAdapter: BaseAdapter {
        ...
        constructor(context: Context, objetosNegocios: ArrayList<ObjetosNegocio>){
            this.context=context
            this.peliculas=objetosNegocios
        }
